export const Photos  = [
    {
        name: "Kobe Bryant",
        slidePath: "../assets/imgs/KobeBryant.jpg",
        thumbnailPath: "../assets/thumbnails/KobeBryant.jpg",
    ...
    {
        name: "Kevin Durant",
        slidePath: "../assets/imgs/KevinDurant.jpg",
        thumbnailPath: "../assets/thumbnails/KevinDurant.jpg",
    ...
    {
        name: "Kyrie Irving",
        slidePath: "../assets/imgs/KyrieIrving.jpg",
        thumbnailPath: "../assets/thumbnails/KyrieIrving.jpg",
    ...
    {
        name: "Stephen Curry",
        slidePath: "../assets/imgs/StephenCurry.jpg",
        thumbnailPath: "../assets/thumbnails/StephenCurry.jpg",
    ...
    {
        name: "Kawhi Leonard",
        slidePath: "../assets/imgs/KawhiLeonard.jpg",
        thumbnailPath: "../assets/thumbnails/KawhiLeonard.jpg",
